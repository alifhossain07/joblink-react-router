...
const AppliedJobs = () => {
    ...
    return (
        <div className="mt-14 mb-14">
            <h2 className="text-center text-3xl font-bold text-sky-700 mb-10">Jobs I Applied : {appliedJobs.length}</h2>
            <ul>
                {
                    appliedJobs.map(job => 
                        <li key={job.id}>
                        <div className='bg-sky-100 shadow-2xl mb-5 p-10 space-y-4 w-3/6 mx-auto rounded-3xl'>
